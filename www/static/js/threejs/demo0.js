...
(function() {
  ...
  $(function() {
    var THREE, animate, camera, current_texture, distance, isPlaying, isUserInteracting, lat, lon, material, onPointerDown, onPointerDownLat, onPointerDownLon, onPointerDownPointerX, onPointerDownPointerY, onPointerMove, onPointerUp, onWindowResize, phi, renderer, scene, theta, update, video_list, video_list_index;
    THREE = THREEJS;
